            ...
            <div class="tray tray-center">
                <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" name="newform" id="newform" method="POST" action="" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="form-group admin-form">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="control-label">Upload Image Item* size (340x390)</label>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" name="editform" id="editForm" method="POST" action="" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="form-group admin-form">
                                            ...
                                            <div class="col-xs-12 text-center" style="padding: 30px 15px;">
                                                <div class="col-xs-12">
                                                    <label>Drag Aditional Item Images here</label>
                                                </div>
                                                <div class="col-xs-12">
                    ...
                    <div class="panel panel-visible">
                        <div class="panel-heading">
                            <div class="panel-title hidden-xs"><span class="glyphicon glyphicon-tags"></span><b class="text-primary">Hardware</b> Item Details</div>
                        </div>
